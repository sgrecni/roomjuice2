            ...
            {playlist.map((song, index) => {
              ...
              return (
                <div 
                  ...
                  className={`cursor-pointer flex items-center justify-between p-3 sm:p-4 border-b border-slate-100 dark:border-slate-800/50 transition-colors group w-full ${
                    isPlaying 
